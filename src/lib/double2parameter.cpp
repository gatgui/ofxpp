...
void Double2ParameterDescriptor::defaultValue(double *v0, double *v1) {
...
void Double2ParameterDescriptor::increment(double i) {
...
void Double2ParameterDescriptor::digits(int d) {
...
void Double2ParameterDescriptor::doubleType(DoubleParamType t) {
  setString(kOfxParamPropDoubleType, 0, DoubleParamTypeToString(t));
}

void Double2ParameterDescriptor::dimensionLabel(int i, const std::string &name) {
...
void Double2ParameterDescriptor::defaultCoordinateSystem(Coordinates cs) {
...
void Double2Parameter::increment(double i) {
...
void Double2Parameter::digits(int d) {
